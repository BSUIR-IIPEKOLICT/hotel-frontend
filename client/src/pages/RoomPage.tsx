        ...
        <Container maxWidth='sm'>
            <Paper component='div' sx={{flexGrow: 1, p: 2, my: 2}}>
                ...
                <Box component='div' sx={{p: 1}}>
                    <Typography component='h6' variant='h6' sx={{marginBottom: 1}}>Pricing</Typography>
                    <Typography component='div' variant='button' sx={{color: palette.success.main}}>
                        {price + placesPrice}$ per day
                    </Typography>
                </Box>
                <Divider />
                <Box component='form' noValidate autoComplete='off' sx={{py: 1}}>
                    <Typography component='h6' variant='h6' sx={{color: palette.primary.main}}>
                        Book a room
                    </Typography>
                    <Grid container>
                        <Grid item md={6}>
                        ...
                        <Grid item md={6}>
                            <Container sx={{textAlign: 'center'}}>
                                <AppSelect
                                    changeHandler={value => setPlacesPrice(parseInt(value) * 50)}
                                    label='places'
                                    options={selectOptions.options}
                                    values={selectOptions.values}
                                />
                                <Button variant='contained' sx={{m: '0 auto'}}>Book this room</Button>
                            </Container>
                        </Grid>
                    </Grid>
                </Box>
